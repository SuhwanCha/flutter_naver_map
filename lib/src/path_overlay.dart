...
class PathOverlay extends Equatable {
  const PathOverlay(
    this.pathOverlayId,
    this.coords, {
  ...
  /// 경로선의 색상을 지정합니다.
  ///
  /// 경로선의 색상은 반투명일 수 없으며, 완전히 투명하거나 완전히 불투명해야 합니다. 색상의 알파가 0이
  /// 아닌 경우 완전히 불투명한 것으로 간주됩니다. 색상이 투명할 경우 테두리도 그려지지 않습니다.
  /// 기본값은 [Colors.white]입니다.
  final Color color;

  /// 경로선의 테두리 색상을 지정합니다.
  ///
  /// 경로선의 테두리 색상은 반투명일 수 없으며, 완전히 투명하거나 완전히 불투명해야 합니다.
  /// 색상의 알파가 0이 아닌 경우 완전히 불투명한 것으로 간주됩니다.
  ...
  /// 지나온 경로선의 색상을 지정합니다.
  ///
  /// 지나온 경로선의 색상은 반투명일 수 없으며, 완전히 투명하거나 완전히 불투명해야 합니다. 색상의
  /// 알파가 0이 아닌 경우 완전히 불투명한 것으로 간주됩니다. 색상이 투명할 경우 테두리도 그려지지 않습니다.
  /// 기본값은 [Colors.white]입니다.
  final Color passedColor;

  /// 지나온 경로선의 테두리 색상을 지정합니다.
  ///
  /// 지나온 경로선의 테두리 색상은 반투명일 수 없으며, 완전히 투명하거나 완전히 불투명해야 합니다.
  /// 색상의 알파가 0이 아닌 경우 완전히 불투명한 것으로 간주됩니다.
  /// 기본값은 [Colors.black]입니다.
  ...
  ///
  /// 경로선에서 0.0 ~ [progress]의 선형은 지나온 경로로 간주되어 [passedColor]와
  /// [passedOutlineColor]가 사용됩니다. [progress] ~ 1.0의 선형은 지나갈 경로로 간주되어
  /// [color]와 [outlineColor]가 사용됩니다.
  /// 기본값은 0.0입니다.
...
Map<PathOverlayId, PathOverlay> _keyByPathOverlayId(
  ...
  return Map<PathOverlayId, PathOverlay>.fromEntries(
    pathOverlays.map(
